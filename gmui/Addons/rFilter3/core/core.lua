  ...
  local createIcon = function(f,index,type)
    ...
    sh:SetPoint("CENTER")
    sh:SetTexture("Interface\\AddOns\\MyMedia\\RMEDIA\\textures\\outer_shadow")
    sh:SetVertexColor(0, 0, 0, 0)
    ...
    bo:SetPoint("CENTER")
    bo:SetTexture("Interface\\AddOns\\MyMedia\\RMEDIA\\textures\\gloss")
