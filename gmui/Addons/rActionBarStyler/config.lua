  ...
  cfg.bars = {
	...
	bar3 = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = 0, y = 86 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    petbar = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -128, y = 145 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    stancebar = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -150, y = 252 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    extrabar = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = 300, y = 38 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    leave_vehicle = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = 260, y = 30 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
