...
L["Adjust Blizzard Frames"] = "Blizzard-Fenster verschieben"
...
L["Delay"] = "Verzögerung"
L["Desaturated Icons"] = "Graue Icons"
...
L["Show icons in gray scale mode (This will not affect icons embedded in the text of a plugin)."] = "Icons in Graustufen anzeigen. (Dies betrifft keine Icons, die im Text eines Plugins eingebettet sind.)"
