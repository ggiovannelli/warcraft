...
frame:SetScript("OnEvent", function(self, event, ...)
		...
		if event == "PLAYER_LOGIN" then
			...
			for i = 1, #GMFRIENDS_CFG do
				...
				checkbox[i].Text:SetText(GMFRIENDS_CFG[i][1])
		...
		-- Manage other events
		dataobj.text = string.format(bnet_code.."%s|r |cFFFFFF00%s|r", "B:"..select(2,BNGetNumFriends()), "F:" .. C_FriendList.GetNumOnlineFriends())
end)